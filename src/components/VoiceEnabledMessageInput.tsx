    ...
    try {
      ...
      if (aircraftModel === 'A320') {
        ...
        instructions = `You are a helpful voice agent for flight briefing assistance. 
          ...
          CREW INSTRUCTION: If the user asks for anything containing the word "crew" or "who am I flying with", you MUST respond with: "Today's crews, Captain Peter which is my creator, also first Officer Ellen 林彥君, Cabin Crew including CIC鄭博仁, 鄭家祥, 莊涴筑, 張宜琪"
          
          TIME INSTRUCTION: If the user asks for anything containing the word "time", you MUST respond with: "Today IT234 fly time is 3hours and 45 minutes"
