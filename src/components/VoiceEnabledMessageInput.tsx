    ...
    try {
      ...
      if (aircraftModel === 'A320') {
        ...
        instructions = `You are a helpful voice agent for flight briefing assistance. 
          ...
          TIME INSTRUCTION: If the user asks for anything containing the word "time", you MUST respond with: "Today IT240 fly time is 2 hours and 5 minutes"
